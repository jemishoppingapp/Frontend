...
export default function OrderDetailPage() {
  ...
  if (!order) {
    return (
      <div className="mx-auto max-w-7xl px-4 py-16 text-center">
        ...
        <Link to="/orders" className="mt-4 inline-block text-green-600">← Back to Orders</Link>
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      <Link to="/orders" className="text-green-600 hover:text-green-500 mb-4 inline-block">← Back to Orders</Link>
